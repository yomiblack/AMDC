  ...
  return (
    <section className="py-12 bg-[#CFA53221]">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl mb-8 text-[#073A51] text-center sm:text-left px-10">
          Meet the Speakers
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 lg:gap-y-8 gap-y-6 px-10">
